    ...
    <div className="project">
      <div className="project-header" id="maps-header">
        ...
        <p className="project-subheading project-github">
          <a href="https://github.com/allenwang1536/spotiduo" target="_blank">
            <u>Github</u>
          </a>
          ,{" "}
          <a href="https://youtu.be/qPu-ch3UULo?si=SnW86_6t7oGq32pT" target="_blank">
            <u>Video</u>
          </a>
        </p>
      </div>
      ...
      <div className="project-text" id="introduction">
        <div className="project-section">
          ...
          <p>
            This is a challenge faced by millions of immigrants and non-native English speakers daily. Even with a basic
            understanding of English, they struggle with colloquial phrases and slang found in everyday conversations
            and songs.
          </p>
        </div>
        <div className="project-section">
          ...
          <p>
            ...
            karaoke-style lyric input alongside real-time translations for over 150 native dialects, a tiered difficulty
            system, and personalized song recommendations.
          </p>
        </div>
        <div className="project-section">
          <p className="project-sub-subheading">Video Demonstration</p>
          ...
          <p>
            My responsibilities for this project included the Spotify OAuth, lyric translation integration, game logic,
            and recommendations. Keep scrolling for an in-depth look at the technical features implemented!
          </p>
        </div>
      </div>
      <div className="project-header" id="maps-header">
      ...
      <div className="project-text" id="technical-features">
        <div className="project-section">
          ...
          <p>
            ...
            randomly generated code verifier. The app then directs the user to Spotify's authorization page, where they
            log in and grant permissions. Once authorized, SpotiDuo exchanges the authorization code and other
            credentials for an access token. This approach requires a code verifier to prevent unauthorized access, and
            by generating a new verifier and challenge for each attempt, it ensures strong security practices.
          </p>
          <div className="project-pics">
        ...
        <div className="project-section">
          ...
          <p>
            After logging in, the user selects a song in the language they're learning, their native language (from 150+
            options), and the desired difficulty level. SpotiDuo then automatically retrieves lyrics from a custom
            backend that my teammates worked on.
          </p>
          <p>
          ...
          <p>
            <i>Challenge: </i>The Musixmatch API doesn't provide lyrics for every song on Spotify, so after discussion,
            we decided to cross-check the available songs before displaying them to the user.
          </p>
        </div>
        <div className="project-section">
          <p className="project-sub-subheading">Game Logic</p>
          <p>
            After selecting the game settings, users proceed to the gameplay, where they listen to the song and fill in
            lyric blanks based on what they hear, aided by translation hints in their native language. At the end of the
            game, they receive a score and feedback on their performance.
          </p>
          <p>
        ...
        <div className="project-section">
          ...
          <p>
            After completing the game, users receive personalized song recommendations based on their initial selection.
            SpotiDuo analyzes over 20 attributes, including energy, mood, and danceability, to find five songs that
            closely match those traits using the Spotify API.
          </p>
          <div className="project-pics">
      ...
      <div className="project-text" id="conclusion">
        <ul>
          ...
          <li>
            <p>
              With that being said, I'm still constantly learning new things with every project. Working with Spotify’s
              API for visual displays was fascinating, and though there were some display challenges, tackling them
          ...
          <li>
            <p>
              ...
              accurate translations, and seamless Spotify integration showed me how crucial it is to focus on creating a
          ...
          <li>
            <p>
              ...
              personalized recommendations, I learned the importance of clear communication and planning to achieve the
              best results. Four heads are certainly better than one!
            </p>
          </li>
        </ul>
      </div>

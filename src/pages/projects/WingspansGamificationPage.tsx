      ...
      <div className="project">
        <div className="project-header" id="maps-header">
          ...
          <p className="project-subheading project-github">
            <a href="https://www.wingspans.com/" target="_blank" rel="noreferrer">
              Website
            </a>
          </p>
        </div>
        ...
        <div className="project-text" id="introduction">
          <div className="project-section">
            ...
            <p>
              ...
              including career stories, resume builders, and tailored career plans. Recognizing the need to increase
              user engagement, my CEO tasked me with exploring new strategies. After discussion, we decided to implement
          ...
          <div className="project-section">
            ...
            <p>
              ...
              interaction models helped me create designs on Figma, which aimed to integrate these gamified elements
              into Wingspans.
            </p>
            <p>Keep reading to see how <b>I increased user view time by approximately ~70!</b></p>
          </div>
        </div>
        ...
        <div className="project-text" id="technical-features">
          <div className="project-section">
            ...
            <p>
              To manage these points, I stored them in a field in our backend Firestore database. Then, every time a
              user completed an action, I would update this field to reflect their new total. Concurrently, I ensured
            ...
            <p>
              ...
              there was a noticeable delay, which could potentially harm the user experience. To solve this, I
              implemented a local caching system. Now, when users earn points, their totals are instantly updated on
              their current session through this cached data, while an asynchronous update is made to their profile
              stored in Firebase. This approach ensures that users see their points update immediately, enhancing their
              engagement without waiting for the backend to catch up.
            </p>
          </div>
          <div className="project-section">
            ...
            <p>
              To visually inform users of their progression, I implemented a notification feature using a React modal
              that pops up whenever a user levels up. I used a useEffect hook in React, monitoring the pointTotal state.
              This setup ensures that any change in the user's points automatically triggers a check. If the new points
        ...
        <div className="project-header" id="impact">
        ...
        <div className="project-text" id="technical-features">
          <div className="project-section">
            ...
            <p>
              ...
              user engagement. Specifically, average site view time escalated from 15 minutes and 22 seconds to nearly
              22 minutes by November—an <b>increase of approximately 70%!</b> This significant growth in engagement time
          ...
          <div className="project-section">
            ...
            <p>
              Looking ahead, we plan to further enhance user motivation by linking level achievements to tangible
              rewards. For example, reaching a basic level could reward users with a free sheet of resume tips, while
              advancing to a medium level might offer a mentorship meeting. Achieving a high level could even secure an
              interview for an internship. These rewards are designed to encourage users to engage more deeply with the
          ...
          <ul>
            <li>
              <p>
                ...
                Surprisingly, most of my time was spent researching the problem and exploring various existing
                solutions. Once I had a clear understanding of the optimal solution, implementing it was relatively
                straightforward.
              </p>
            </li>
            <li>
              <p>
                Experiencing real-world challenges like latency issues with Firestore was eye-opening. Until this
                project, I had operated on the assumption that computer networks and systems operated perfectly and
            ...
            <li>
              <p>
                ...
                experience in feature development, teaching me much about the practical aspects of building and
                deploying software. I'm excited to build out more solutions to intriguing problems!
              </p>
            </li>
          </ul>
        </div>
